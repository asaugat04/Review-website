// import ReviewsPageLeft from "./ReviewsPageLeft";
// import ReviewsPageRight from "./ReviewsPageRight";
import GiveReviewStar from "./GiveReviewStar";
import UserReview from "./UserReview";

export default function ReviewsPage({ activeTab }) {
  let details = [
    {
      name: "Chandler",
    ...
    <div className="flex  justify-center md:gap-x-32 flex-col md:flex-row ">
      ...
      <div>
        ...
        <div className="pagination flex justify-center items-center">
          ...
          <a
            href="#"
            className="active ml-2 border rounded w-7 h-7 text-center "
          >
            1
          </a>
